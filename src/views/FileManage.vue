      ...
      <main>
        ...
        <div class="file-panel">
          <div class="toolbar">
            ...
            <ObjectTable
              :data-source="filteredSource"
              :loading="tableState.loading"
              :selected-row-keys="tableState.selectedRowKeys"
              :is-virtual-bucket-list="isInVirtualBucketList"
              :bucket-mount-info-map="bucketMountInfoMap"
              :list-loading-more="listLoadingMore"
              :list-loaded-pages="listLoadedPages"
              :next-continuation-token="tableState.nextContinuationToken"
              :endpoint="activeConnectionEndpoint"
              :scope="activeConnectionScope"
              :mount-status="currentBucketMountStatus"
              :mount-point="currentBucketMountPoint || ''"
              :vfs-sync-state="vfsSyncState"
              :vfs-failed-files="vfsFailedFiles"
              v-model:page-current="paginationState.current"
              v-model:page-size="paginationState.pageSize"
              @update:selected-row-keys="(keys) => { tableState.selectedRowKeys = keys as any; }"
              @selection-change="handleFileTableRowSelection"
              @row-select="handleFileTableRowSelect"
              @row-click="handleRowClick"
              @row-dblclick="handleRowDblClick"
              @row-contextmenu="handleContextMenu"
              @blank-contextmenu="handleBlankAreaContextMenu"
              @nav-hover="handleNavPopupHover"
              @nav-leave="handleNavPopupLeave"
              @upload-to-directory="handleUploadToDirectory"
              @download="handleStorageGetObject"
              @preview="handlePreviewObject"
              @sign="handleStorageSignObject"
              @delete="handleStorageDeleteObjects"
              @cancel-load="cancelBackgroundListLoad"
              @page-change="handlePaginationChange"
              @page-size-change="handlePaginationSizeChange"
            />
...
import { AutoComplete, Modal, notification, theme } from 'ant-design-vue';
import {
  ArrowUpOutlined,
  ArrowDownOutlined,
  DownOutlined,
